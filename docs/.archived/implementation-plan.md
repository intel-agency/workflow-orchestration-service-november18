...
>
> **Scope:** Template repo `workflow-orchestration-service-november18` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
